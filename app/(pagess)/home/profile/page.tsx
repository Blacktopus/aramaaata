                ...
                <div className="mobile-wrapper">
                    ...
                    <div className="avatar">
                        ...
                        <div className="avatar-content">
                            <div className="avatar-content_image" style={{ backgroundImage: `url(${user.user_avatar})` }}></div>
                    ...
                    <div className="personally_input">
                        ...
                        <div className="personally_input-input">
                            ...
                            <input type="text" disabled={true} placeholder={ user.user_firstname + ' ' + user.user_lastname }/>
                        </div>
                    </div>
                    <div className="ratings">
                        ...
                        <div className="ratings_wrapper">
                            <div className="user-rating">
                               ...
                               <div>{ user.user_ration }<span>/10</span></div>
                            </div>
                        </div>
                    </div>
                </div>
